...
public class CrironaMess : NetworkBehaviour
{
    ...
    private CrironaNet networkManager;
    ...
    public void Awake()
    {
        ...
        networkManager = (Instantiate(Resources.Load("CrironaNetworkManager")) as GameObject).GetComponent<CrironaNet>();
        if (networkManager != null)
        {
            //networkManager.logLevel = 0;

            networkManager.name = "CrironaNetworkManager";
            ...
            if (useDebugGUI)
                networkManager.GetComponent<CrironaGUI>().enabled = true;
        }
        else
    ...
    public void Update()
    {
        if (networkManager == null)
        {
            networkManager = FindObjectOfType(typeof(CrironaNet)) as CrironaNet;
            networkManager.listener = listener;
    ...
    public List<CrironaMessPlayer> Players()
    {
