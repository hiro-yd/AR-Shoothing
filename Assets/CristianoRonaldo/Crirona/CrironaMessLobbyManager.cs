...
public class CrironaMessLobbyManager : NetworkManager
{
    public int minPlayers = 2;
    public int maxPlayers = 4;
    public CrironaMessPlayer[] lobbySlots;
    ...
    public override void OnStartServer()
    {
        ...
        {
            lobbySlots = new CrironaMessPlayer[maxPlayers];
        }
    }
    ...
    public override void OnServerAddPlayer(NetworkConnection conn, short playerControllerId)
    {
        ...
        var newLobbyPlayer = newLobbyGameObject.GetComponent<CrironaMessPlayer>();
    ...
    {
        byte slot = player.gameObject.GetComponent<CrironaMessPlayer>().slot;
    ...
    {
        OnLobbyClientEnter();
        foreach (CrironaMessPlayer player in lobbySlots)
        {
            if (player == null)
                continue;
